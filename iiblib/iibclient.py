...
class IIBBuildDetailsModel(object):
    ...
    _data_attrs = [] # TODO fill in
    _kwarttrs = []

    def __init__(self, *args, **kwargs):
        self.data = {}
        for attr, attr_val in zip(args, _data_attrs):
    ...
    def from_dict(cls, data): # TODO na zaklade request type ne class
        ...
        #     data.get("from_index"),
        #     data["from_index_resolved"],  # Missing in regenerate
        #     data.get("bundles", []),
    ...
    def __eq__(self, other): #TODO i might not needed it
        return self == other
        # if (
        #     self.id == other.id
